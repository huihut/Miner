...
#ifndef MINER_MFILESYSTEM_H
#define MINER_MFILESYSTEM_H
...
namespace miner
{
    namespace io
    {
        ...
        */
        class MFileSystem : public MUnknow
        {
        public:
            ...
            virtual MReadFile* createAndOpenFile(const c8* filename) = 0;
            ...
            //! See IUnknown::drop() for more information.
            virtual MFileList* createFileList() = 0;
